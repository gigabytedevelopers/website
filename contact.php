		...
		<div class="container-fluid no-padding">
			...
			<div class="col-lg-6 col-lg-12 col-sm-12 col-xs-12 no-padding">
                ...
                <!--<script>
                    ...
                    function initMap() {
                      // The location of Gigabyte Developers
                      var address = {lat: 5.512608, lng: 7.495645};
                      // The map, centered at Gigabyte Developers
                      var map = new google.maps.Map(
                          document.getElementById('map'), {zoom: 17, center: address, scrollwheel: false});
                      // The marker, positioned at Gigabyte Developers
				...
				<!--<script>
					...
					function initMap() {
						...
						map = new google.maps.Map(document.getElementById('map'), {
							center: {lat: 5.512608, lng: 7.495645},
							zoom: 12,
							scrollwheel: false//set to true to enable mouse scrolling while inside the map area
						});
					}
				</script>-->
				<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkKEZ-jxBp51pa--wWnoncueVC_6cqtFc&callback=initMap"
						async defer>
				</script>-->
