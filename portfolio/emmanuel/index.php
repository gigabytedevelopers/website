    ...
    <header class="mdl-color--indigo-700 mdl-color-text--white mdl-shadow--4dp">
        ...
        <section class="skills">
            ...
            <div>
                ...
                <ul>
                    <li>
                        <p class="mdi mdl-typography--menu menuText">Cloud Developer</p>
                        <p class="mdl-typography--body-1">Nanodegree Certificate issued by Udacity
                            <br>(October, 2022)
                            <br>Certificate ID:
                            <a href="https://graduation.udacity.com/confirm/XYHGFYNE" class="certID">XYHGFYNE</a>
                        </p>
                    </li>
                    <li>
                        ...
                        <p class="mdl-typography--body-1">Certificate issued by Google
                            <br>(June, 2019)
                            <br>Certificate ID: <strong>EL4W2LAV6</strong>
                        </p>
                    </li>
                </ul>
            </div>
        ...
        <section class="mdl-color--white mdl-shadow--2dp">
            ...
            <section>
                ...
                <ul class="mdl-typography--subhead mdl-typography--subhead-color-contrast">
                    ...
                    <li>Developing and overseeing the IT budget.</li>
                    <li>Planning, deploying and maintaining IT systems and operations.</li>
                    <li>Managing the organization's software development needs.</li>
                    <li>Developing IT policies, procedures and best practices.</li>
                    <li>Developing and enforcing IT best practices across the organization.</li>
                    <li>Ensuring IT strategies and processes support company-wide goals.</li>
                    <li>Overseeing relationships with vendors, contractors and service providers.</li>
                </ul>
            </section>
            <section>
