...
<header class="mdl-color--indigo-700 mdl-color-text--white mdl-shadow--4dp">
    ...
    <section class="about">
        ...
        <div>
            ...
            <p>Experienced Software Developer with a demonstrated history of working in the Industry, designing and developing software for business solutions. Skilled in core backend and frontend languages used in Software Development.
                <br>Strong entrepreneurship professional with a Bachelor’s Degree from Nnamdi Azikiwe University and a solid background in project management and customer relations.
                <br><em>Currently building a legacy in Information Technology as the Founder and CEO of Gigabyte Developers Incorporated.</em>
            </p>
        </div>
    </section>
        ...
        <div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p class="mdl-typography--body-1">Windows, Linux, Microsoft SQL Server, Unix, MySQL, JBoss, Ingres, PostgreSQL, Apache Tomcat</p>
                </li>
                <li>
                    <p class="mdl-typography--caption mdl-typography--caption-color-contrast">Other Skills &amp; Industry Knowledge</p>
