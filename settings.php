...
<html lang="en" class="no-js"> <!--<![endif]-->
	...
	<?php include_once("includes/googleanalyticstracking.php") ?>
        <div class="container">
            <header>
                <a href="index"><h1>Gigabyte Developers <span>Edit Profile</h1></a>
            </header>
            <section>				
