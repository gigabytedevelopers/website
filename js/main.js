...
(function ($) {
    ...
    CRUMINA.toggleUserRegister = function () {
        $('.register-popup').toggleClass('open');
    };
    ...
    jQuery(".js-open-login-back-popup").on('click', function () {
    ...
    $document.ready(function () {
        ...
        $('.js-pricing-switcher').on('click', function(){
            var $is_onetime = $(this).prev().is(':checked');
            var $section = $(this).closest('.crumina-pricings');
            var $price = $section.find('.price');
            $price.each(function(){
                if($is_onetime){
                    $(this).text($(this).data('onetime'));
                }else{
                    $(this).text($(this).data('recurring'));
                }
            });
        });

        /*$('input.onetimeCheck').removeAttr('checked');
        $('.js-pricing-switcher-onetime').on('click', function(){
            var $is_onetime = $(this).prev().is(':checked');
            var $sections = $(this).closest('.crumina-pricings');
            var $onetime_price = $sections.find('.price');
            $onetime_price.each(function(){
                if($is_onetime){
