...
?>
                                <p> 
                                    ...
                                    <input id="username" name="username" required="required" type="text" placeholder="Username" value="<?php if(empty($_POST) === false) echo $_POST['username']; ?>" />
                                </p>
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Your password </label>
                                    <input id="password" name="password" required="required" type="password" placeholder="Password" value="<?php if(empty($_POST) === false) echo $_POST['password']; ?>" /> 
                                </p>
                                <p class="keeplogin"> 
