        ...
        <div class=carousel-inner>
            <div class="item active" style=background-image:url(images/slider/1.jpg)>
                <div class=caption>
                    ...
                    <p class=animated>The Best Programming Hub For You</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/2.jpg)>
                <div class=caption>
                    <h1 class=animated>Say Hello to <span>Gigabyte</span></h1>
                    <p class=animated>Moving Programmers Forward</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/divider2.jpg)>
                <div class=caption>
                    ...
                    <p class=animated>Our social network called <a href=javascript:void(0) class=captions><strong>Tawkk</strong></a> offers you the best out-of-box social media experience</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/rappixmg.jpg)>
                <div class=caption>
                    <h1 class=animated>We are <span>Creative</span></h1>
                    <p class=animated>Creativity, Your First Choice For Success</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/wisezy.jpg)>
                <div class=caption>
                    ...
                    <p class=animated>Number one option for your services</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/5.jpg)>
                <div class=caption>
                    <h1 class=animated>We are 100% <span>Efficient</span></h1>
                    <p class=animated>Our work speak for itself</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/3.jpg)>
                <div class=caption>
                    <h1 class=animated>We are <span>Unique</span></h1>
                    <p class=animated>There are no other like us in the world</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/4.jpg)>
                <div class=caption>
                    <h1 class=animated>We are <span>Top Class</span></h1>
                    <p class=animated>Always on top of our league!</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
            <div class=item style=background-image:url(images/slider/6.jpg)>
                <div class=caption>
                    <h1 class=animated>24/7 <span>Customer Support</span></h1>
                    <p class=animated>Our Support agents are always ready to answer!</p><a href=#services class="animated btn btn-start" data-scroll>Start now</a></div>
            </div>
        </div><a href=#services id=tohash><i class="fa fa-angle-down"></i></a></div>
    <div class=main-nav>
        <div class=container>
                                        ...
                                        <li class=scroll><a href=#classes>Classes</a>
                                            <li class=scroll><a href=#blog>Blog</a>
                                                <li class=scroll><a href=#contact>Contact</a>
                                                    <li class=dropdown><a href=javascript:void(0) class=dropdown-toggle aria-expanded=false aria-haspopup=true data-toggle=dropdown id=drop1 role=button><?php if (empty($user_data['profile']) === false) { echo '<img src="', $user_data ['profile'], '" alt="Profle Picture">'; } ?>   Hello,&nbsp<?php echo $user_data ['username']; ?>! <b class=caret></b><br><?php
if (is_admin($session_user_id, 1) === true) {
    echo '<b style="line-height:0.5;float:right;font-size:8px;padding-right:15px;font-weight:normal;font-family:roboto;">Admin!</b>';
} else if (has_access($session_user_id, 2) === true) {
    echo '<b style="line-height:0.5;float:right;font-size:8px;padding-right:15px;font-weight:normal;font-family:roboto;">Moderator!</b>';
}
?></a>
                                                                ...
                                                                <li class=scrollex><a href=settings style="padding-left:32px;"><i class="fa clicks fa-edit"></i>Update Profile</a>
                                                                    <li class=scrollex><a href=picture style="padding-left:35px;"><i class="fa clicks fa-picture-o"></i>Profile Picture</a>
                                                                        <li class=scrollex><a href=changepassword style="padding-left:32px;"><i class="fa clickss fa-cogs"></i>Edit Password</a>
                                                                            <li class=scrollexer><a href=javascript:void(0) target=_blank><i class="fa clicksss fa-comments" style="padding-left:-7px;"></i>Tawkk</a>
                                                                                <li class=scrollex><a href=search style="padding-left:30px;"><i class="fa fa-search gnss"></i>Search</a>
                                                                                    <?php
if (is_admin($session_user_id, 1) === true) {
