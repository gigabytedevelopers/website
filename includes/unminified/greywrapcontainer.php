<div id=greywrap>
    <div class=container>
        <div class=row>
            <div class="col-lg-8 centered wow fadeInLeftBig" data-wow-duration=1000ms data-wow-delay=300ms> <img class=img-responsive alt=Hire src=./images/macbook.png align> </div>
            ...
            <div class="wow fadeInRightBig" data-wow-duration=1000ms data-wow-delay=600ms>
                <p> <a href=./contact target=_blank class="btns btns-success" style=float:center;>Contact Us</a>
                    <!-- <script style="display: inline-block" type="text/javascript" src="https://ko-fi.com/widgets/widget_2.js"></script><script type='text/javascript'>kofiwidget2.init('Buy Us a Coffee', '#028fcc', 'A561ND8');kofiwidget2.draw();</script> -->
                </p>
            </div>
