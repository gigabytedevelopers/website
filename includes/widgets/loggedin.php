      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
			...
			<li class="dropdown">
            <a id="drop1" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hello, <?php echo $user_data['first_name']; ?>! <b class="caret"></b></a>
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            <h2>Our Services</h2>
            <p>Our team at Gigabyte Developers Incorporated work ceaselessly to offer you a wide range of professional services in and outside the computer world of technologies. You can also <a href="contact.php" target="_blank">Contact Us</a> if you want to know more about the services we render to our customers.</p>
          </div>
        </div> 
      </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="single-table wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              ...
              <a href="javascript:void(0)" class="btn btn-lg btn-primary">Sign up</a>
            </div>
          </div>
          <div class="col-sm-3">
		...
		<div class="container">
			<div class="row">
				...
				<div class="wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="600ms">
					<p>
					<a href="contact.php" target="_blank" class="btns btns-success">Contact Us</a></p>
				</div>				
                ...
                <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="name">
					  <input type="text" name="name" class="form-control" placeholder="Name" data-constraints="@Required @JustLetters">
                    </div>
                  </div></label>
                  <div class="col-sm-6">
                    <div class="form-group">
					<label class="email">
                      <input type="email" name="email" class="form-control" placeholder="Email Address" data-constraints="@Required @JustLetters">
                    </div>
                  </div>
                </div></label>
                <div class="form-groups">
				<label class="subject">
                  <input type="text" name="subject" class="form-control" placeholder="Subject" data-constraints="@Required @JustLetters">
                </div></label>
                <div class="form-groups">
				<label class="message">
                  <textarea name="message" id="message" class="form-control" rows="4" placeholder="Enter your message" data-constraints='@Required @Length(min=20,max=999999)'></textarea>
                </div></label>                       
                <div class="form-group">
