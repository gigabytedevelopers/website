<header id="home">
      ...
      <div class="carousel-inner">
		...
		<div class="item" style="background-image: url(./images/slider/divider2.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">Our social network called <a class="captions" href="javascript:void(0)"><strong>Weiglo</strong></a> offers you the best out-of-box social media experience </p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
    ...
    <div class="item" style="background-image: url(./images/slider/6.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">Our Support agents are always ready to answer! </p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
      </div>
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <ul class="dropdown-menu" aria-labelledby="drop1">
              <li class="scrollex"><a href="register">Sign Up</a></li>
              <li class="scrollex"><a href="login">Log In</a></li>
            </ul>
          </li>
          </ul>
        </div>
