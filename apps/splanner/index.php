...
<?php include_once("../../includes/googleanalyticstracking.php") ?>
                ...
                <div class="navigation" id="navigation-scroll">
                        <div class="row">
                            <div class="col-md-11 col-xs-10">
                                <a href="index.html"><span id="logo"><strong class="strong">S</strong>PLANNER</span></a>
                            </div>
            ...
            <div class="starting">
                <div class="row">
                    <div class="col-sm-5 col-xs-12">
                        <img src="img/splanner.png" alt="SPLANNER" class="wow flipInY animated animated">
                    </div>
                    <div class="col-md-6">
                        <div class="banner-text">
                            ...
                            all needs</h2>
                            <p>
                                 Splanner has been downloaded and loved by over 10M+ people from 130 countries all over the world in last 3 months. Download this free app on your Android and iOS device. Reviews and ratings are much appreciated.
                            </p>
    ...
    <div id="video" class="wrapper">
        <div class="container">
            ...
            <img src="img/feature.png" alt="features" class="video img-responsive animation-box wow animated bounceInDown">
            <p>
                Use Splanner – The Best Responsive App (brief).
            </p>
        </div> <!-- /.container -->
    </div> <!-- /#video -->
                ...
                <div class="col-sm-4">
                    <ul class="item-list-right item-list-big">
                        <li class="wow fadeInLeft animated"> <i class="fa fa-film"></i> 
                            ...
                            <p>Gigabyte Developers Incorporated.</p>
                        </li>
                ...
                <div class="col-sm-4 col-sm-push-4">
                    <ul class="item-list-left item-list-big">
                        <li class="wow fadeInRight animated"> <i class="fa fa-life-ring"></i>
                            ...
                            <p>SPLANNER is shipped with well documented moduler codes. Meaningfull Comments in code will help US to customize it easily.</p>
                        </li>
                        <li class="wow fadeInRight animated"> <i class="fa fa-lock"></i>
                            <h3>Easily Customizable</h3>
                            <p>SPLANNER is easy to customize. No heavy coding is required to customize it with your real contents.</p>
                        </li>
                        <li class="wow fadeInRight animated"> <i class="fa fa-star"></i>
                            <h3>Future Support</h3>
                            <p>We will update SPLANNER and fix bugs if you found one for a long time.</p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="circle"></div>
                <div class="col-xs-12">
                    <div id="screenshots" class="owl-carousel owl-theme">
                      <a href="img/1.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Introduction to Splanner">
                        <img src="img/1.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/2.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="GPA and CGPA Calculator">
                        <img src="img/2.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/3.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Registration Page For All Students">
                        <img src="img/3.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/4.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Course Registration Dialog">
                        <img src="img/4.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/5.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Default Course Selection">
                        <img src="img/5.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/6.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Navigation Panel">
                        <img src="img/6.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/7.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Semester Selected Courses">
                        <img src="img/7.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/8.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Text Editor NotePad">
                        <img src="img/8.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/9.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="GPA and CGPA Result">
                        <img src="img/9.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                      <a href="img/10.jpg" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots" title="Settings Page for all Students">
                        <img src="img/10.jpg" class="img_res wow animated zoomIn" alt="">
                      </a>
                    </div>
                        ...
                        <div id="client-speech" class="owl-carousel owl-theme">
                            <div class="item wow animated bounceInUp animated">
                                ...
                                <p class="client-comment text-center">
                                    Ask Chisom what she thinks about Splanner
                                </p>
                                <div class="row text-center">
                                    <p class="client-name text-center">Chisom Ezeani</p>
                                </div>
                            </div>
                            <div class="item wow animated bounceInUp animated">
                                <!-- <img class="img-circle img-responsive center-block test-img" src="img/test2.png" alt="text"> -->
                                <p class="client-comment text-center">
                                   He's one of our Beta Testers. I would ask him what he thinks about Splanner
                                </p>
                                <div class="row text-center">
                                    <p class="client-name text-center">Emskaro</p>
                                </div>
                            </div>
                            <div class="item wow animated bounceInUp animated">
                                <!-- <img class="img-circle img-responsive center-block test-img" src="img/test3.png" alt="text"> -->
                                <p class="client-comment text-center">
                                   He's part of the team, stays at my place. Would ask his what he thinks about Splanner.
                                </p>
                                <div class="row text-center">
                                    <p class="client-name text-center">Chike Dickson</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="team" class="wrapper">
        <div class="container-fluid">
            <h2 class="animation-box wow bounceIn animated">VIDEO TOUR GUIDE</h2>
            <div class="virticle-line"></div>
            <div class="circle"></div>
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="video_text center-content">
                        ...
                        <div class="embed-responsive embed-responsive-4by3">
                            <iframe class="embed-responsive-item" style="border-radius:10px;" width="940" height="400" src="https://www.youtube.com/embed/zpOULjyy-n8" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div> <!-- /.row -->
    ...
    <section id="pricing" class="wrapper">
        ...
        <div class="container">
            <h2 class="animation-box wow bounceIn animated">PRICING</h2>
            <div style="background-color: #FFFFFF;" class="virticle-line"></div>
            <div style="border-color: #FFFFFF;" class="circle"></div>
            <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    <ul class="pricing-table">
                        <li class="wow flipInY animated animated" style="visibility: visible;">
                            <h3>Standard</h3>
                            <span> FREE <small>With Advertisements</small> </span>
                            <ul class="benefits-list">
                                <li>Responsive</li>
                                <li>Documentation</li>
                                <li class="not">TimeTable Notifications</li>
                                <li class="">Course Scheduler</li>
                                <li class="not">Reading Guide</li>
                            </ul>
                            <a href="#" target="_blank" class="buy"><i class="fa fa-shopping-cart"></i></a>
                        </li>
                        <li class="" data-wow-delay="0.4s" style="visibility: hidden; -webkit-animation-delay: 0.4s;">
                        </li>
                        <li class="gold wow flipInY animated animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
                            <div class="stamp"><i class="fa fa-star-o"></i>Donate</div>
                            <h3>Professional</h3>
                            <span> $0.99 <small>Remove all Ads</small> </span>
                            <ul class="benefits-list">
                                <li>Responsive</li>
                                <li>Documentation</li>
                                <li>TimeTable Notification</li>
        ...
        <div  class="container">
            <div class="row">
                <div class="col-md-3 contact-item col-sm-6 col-xs-12 wow animated fadeInLeft">
                    ...
                    <p class="contact">
                        #40, Nnokwa Street <br>
                        World Bank Housing Estate, Umuahia, Abia State. Nigeria.
                    </p>
                </div>
                <div class="col-md-3 contact-item col-sm-6 col-xs-12 wow animated fadeInLeft">
                    ...
                    <h3>Phone</h3>
                    <p class="contact">
                        Mobile: <a href="tel:+2348104309369" class="link">234-810-430-9369</a> <br>
                        Local: <a href="javascript:void(0)" class="link">234-your-number</a>
                    </p>
                </div>
                ...
                <div class="col-md-3 contact-item col-sm-6 col-xs-12 wow animated fadeInRight">
                    ...
                    <h3>Email Address</h3>
                    <p class="contact">
                        <a href="mailto:gigabytedevelopersinc@gmail.com" class="link">Enquiry</a> <br>
                        <a href="mailto:nwokomaemmanuel@gmail.com" class="link">Complaints</a>
                    </p>
                </div>
            </div> <!-- /.row -->
            <form class="row form wrapper" id="formid" action="#">
                ...
                <div class="row">
                    ...
                    <input style="float: right;" class="btn btn-sub" type="submit" value="Send Message">
                </div>
            </form> <!-- /.row -->
        </div> <!-- /.container -->
    </section> <!-- /#contact -->
    ...
    <section id="footer" class="wrapper">
        <div class="container text-center">
            <div class="footer-logo">
                <h1 class="text-center animation-box wow bounceIn animated">splanner</h1>
            </div>
            ...
            <div class="copyright">
                <div class="credits">
                    Made with <i class="fa fa-heart"></i> by <a href="../../" target="_blank">Gigabyte Developers Incorporated</a> 2017, All Rights Reserved
                </div>
            </div>
        </div><!-- container -->
    </section>
