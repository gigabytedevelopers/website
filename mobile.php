      ...
      <div class="carousel-inner">
		...
		<div class="item" style="background-image: url(images/slider/divider2.jpg)">
          <div class="caption">
            ...
            <p class="animated">Our social network called <a class="captions" href="http://localhost/humhub-1.1.0/" target="_blank"><strong>GigabyteNetwork</strong></a> offers you the best out-of-box social media experience </p>
            <a data-scroll class="btn btn-start animated" href="#services">Start now</a>
          </div>
        </div>
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <ul class="dropdown-menu" aria-labelledby="drop1">
              <li class="scrollex"><a href="registerform">Sign Up</a></li>
              <li class="scrollex"><a href="loginform">Log In</a></li>
            </ul>
          </li>
          </ul>
        </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            ...
            <div class="service-info">
              ...
              <p>Gigabyte Developers stand-out unique amongst its competitors in the world of Tech-Know-How.</p>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="service-icon">
            ...
            <div class="service-info">
              <h3><a href="http://localhost/mybb_1807/Upload/index.php">Knowledge Base</a></h3>
          ...
          <div class="col-sm-4">
            ...
            <div class="service-info">
              ...
              <p>Unique and professional Web Design and Graphic Design can be found here at Gigabyte Developers Incorporated</p>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="service-icon">
          ...
          <div class="col-sm-4">
            ...
            <div class="service-info">
              <h3><a href="tutorials.php">Clean Code</a></h3>
      ...
      <div class="row count">
        <div class="col-sm-6">
          <div class="about-info">
            <h2>About us</h2>
            <p>Gigabyte Developers Incorporated is a Non-Governmental Organization which was established to harness and elevate the potential in young tech inclined persons allover the world. Gigabyte Developers Incorporated is known globally for its quality and genuine services. The company was formerly known as Gigabyte Developers but was later in 2016 incorporated with <a href="http://www.accessteam.netne.net">Access Team</a>, <a href="http://www.facebook.com/mezuestudios">Mezue Studios, LLC</a>, <a href="#">Catarax Solutions</a> and <a href="#">Gigabyte Studios Incorporated</a> and from then on, it was transformed from Gigabyte Developers to Gigabyte Developers Incorporated. </p>
            <p>Gigabyte Developers Incorporated was founded in December, 2015 by <br><a href="http://www.facebook.com/austin.nwokoma.9">Mr. Nwokoma Emmanuel</a>. The name of this great company was derived from GIGABYTE which was Mr. Emmanuel's nickname during his days in college. Mr. Nwokoma Emmanuel was called GIGABYTE because of his wide knowledge in Computer Software & Hardware Engineering, his excellent tech skills, including his knowledge of programming in over 8 programming languages. </p>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="our-skills">
            <div class="single-skill">
              <p class="lead" style="text-align: center; font-weight: bold; font-size: 20px;">User Experiances</p>
                <h3 style="text-align: center;">95%</h3>
            </div>
            <div class="single-skill">
              <p class="lead" style="text-align: center; font-weight: bold; font-size: 20px;">Web Design</p>
                <h3 style="text-align: center;">80%</h3>
            </div>
            <div class="single-skill">
              <p class="lead" style="text-align: center; font-weight: bold; font-size: 20px;">Programming</p>
                <h3 style="text-align: center;">75%</h3>
            </div>
            <div class="single-skill">
              <p class="lead" style="text-align: center; font-weight: bold; font-size: 20px;">Fun Activities</p>
                <h3 style="text-align: center;">90%</h3>
              </div>
			<div class="single-skill">
              <p class="lead" style="text-align: center; font-weight: bold; font-size: 20px;">Media Life</p>
          ...
          <div class="col-sm-3">
            <div class="team-member">
              ...
              <div class="member-info">
                ...
                <h4>CEO &amp; Founder</h4>
                <p>Emmanuel works hard to combine his expert technical knowledge with a real eye for design. Working with clients from a wide range of industries around the world. He is the one that makes the Company tick.</p>
              </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="single-table">
              ...
              <a href="registerform" class="btn btn-lg btn-primary">Sign up</a>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="single-table">
    ...
    <div id="contact-us" class="parallax">
      <div class="container">
        ...
        <div class="contact-form">
          <div class="row">
            <div class="col-sm-6">
              <form id="contact-form" method="post" action="sendemailhosted">
                <div class="row">
                  <div class="col-sm-6">
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<div class="row">
						<nav>
							<ul>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="http://www.gigabytestudiosinc.netai.net"><img src="images/partners/partner01.jpg" alt="" class="img-responsives"></a></li>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="http://www.accessteam.netne.net"><img src="images/partners/partner02.jpg" alt="" class="img-responsives"></a></li>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="http://www.mezuestudios.net23.net"><img src="images/partners/mezuestudios.png" alt="" class="img-responsives"></a></li>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="javascript:void(0)"><img src="images/partners/carterax.png" alt="" class="img-responsives"></a></li>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="javascript:void(0)"><img src="images/partners/partner05.jpg" alt="" class="img-responsives"></a></li>
								<li class="col-md-2 col-sm-3 col-xs-6"><a href="javascript:void(0)"><img src="images/partners/partner06.jpg" alt="" class="img-responsives"></a></li>
							</ul>
						</nav>
					</div>
				</div>
	...
	<div class="container" id="contact" name="contact">
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<p><span class="icon icon-home"></span> #40, Nnokwa Street, World Bank Housing Estate, Umuahia, Abia State. Nigeria <br/>
			...
			<div class="col-lg-4">
				...
				<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=G35ZM2EKPVZ9Y"s type="submit" class="btns btns-success">Donate</a>
			</div><!-- col -->
		</div><!-- row -->
	</div><!-- container -->
  <footer id="footer">
